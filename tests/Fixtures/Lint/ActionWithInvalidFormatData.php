...
/**
 * Fixture Action whose constructor carries {@see InvalidFormatFixtureData} — used to verify
 * that {@see FieldInvalidFormat} reaches Data classes injected through Domain Actions.
 */

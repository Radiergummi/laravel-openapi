...
/**
 * Fixture Action whose constructor carries {@see ConflictingTypeFixtureData} — used to verify
 * that {@see FieldConflictingType} reaches Data classes injected through Domain Actions.
 */

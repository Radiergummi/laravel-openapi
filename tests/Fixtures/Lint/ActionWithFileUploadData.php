...
/**
 * Fixture Action whose constructor carries {@see FileUploadFixtureData} — used to verify that
 * {@see MultipartFileWithoutMultipart} reaches Data classes injected through Domain Actions.
 */

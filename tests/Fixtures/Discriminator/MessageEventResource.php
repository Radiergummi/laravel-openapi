...
/**
 * Message-event variant for the OAPI-027 discriminator fixture.
 *
 * @extends ApiResource<object>
 */
final class MessageEventResource extends ApiResource
{
    public const string TYPE = 'message';

    public const string FIELD_BODY = 'body';

    public const string FIELD_SENDER_UUID = 'senderUuid';

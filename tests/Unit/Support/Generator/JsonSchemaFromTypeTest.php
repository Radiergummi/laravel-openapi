...
it('renders an unmapped object type as a humanized resource name, never the FQCN', function (): void {
    ...
    expect($schema->type)
        ...
        ->and($schema->description)->not
        ->toContain('BillingAccount')
        ->and($schema->description)->not
        ->toContain('Internal')
...
it(
    'maps builtin scalar types to their JSON Schema counterparts',
    function (TypeIdentifier $id, string $expected): void {

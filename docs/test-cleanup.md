...
|---|---|---|---|
| Tests passing | 1230 | 1104 | −126 |
| Assertions | 3172 | 2949 | −223 |
| Files deleted | — | 18 | |
| Files moved/split | — | 5 source files → 7 split products | |
| Files rewritten as feature tests | — | 3 | |
| Files trimmed | — | 3 | |
| Rule tests refactored onto factory | — | 56 | |

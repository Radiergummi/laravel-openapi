...
| `response.no-success` | 2 | Operation has no 2xx response. Skipped when the operation declares a default response, which documents the outcome space deliberately (e.g. a never-returning action). |

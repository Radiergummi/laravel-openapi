 ...
 * Fractal, …) should consume this contract via the container so detection stays consistent with the
 * bundled behaviour and any future improvements flow through.
 */

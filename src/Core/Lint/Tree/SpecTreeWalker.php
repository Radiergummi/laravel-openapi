...
use Radiergummi\OpenApi\Core\Lint\Rules\Visitors\ApiRule;
use Radiergummi\OpenApi\Core\Lint\Rules\Visitors\ComponentSchemaRule;
use Radiergummi\OpenApi\Core\Lint\Rules\Visitors\ExampleRule;
use Radiergummi\OpenApi\Core\Lint\Rules\Visitors\FieldRule;
use Radiergummi\OpenApi\Core\Lint\Rules\Visitors\Finalizable;
use Radiergummi\OpenApi\Core\Lint\Rules\Visitors\HeaderRule;
use Radiergummi\OpenApi\Core\Lint\Rules\Visitors\LinkRule;
use Radiergummi\OpenApi\Core\Lint\Rules\Visitors\OperationRule;
use Radiergummi\OpenApi\Core\Lint\Rules\Visitors\ParameterRule;
use Radiergummi\OpenApi\Core\Lint\Rules\Visitors\QueryParameterRule;
use Radiergummi\OpenApi\Core\Lint\Rules\Visitors\RequestBodyRule;
use Radiergummi\OpenApi\Core\Lint\Rules\Visitors\Resettable;
use Radiergummi\OpenApi\Core\Lint\Rules\Visitors\ResponseRule;
use Radiergummi\OpenApi\Core\Lint\Rules\Visitors\WebhookRule;
...
final class SpecTreeWalker
{
    ...
    private function walkFields(
        ...
        foreach ($fields as $field) {
            // Extend defaults with the field's JSON pointer so rules don't have
            // to construct it manually. Rules that set a more specific pointer
            // (e.g., ".../enum/0") will still win via null-coalescing.
            ...
            // Recurse into nested object fields, carrying the current field's
            // defaults (including its JSON pointer) so nested findings reference
            // the correct parent path rather than the operation-level defaults.

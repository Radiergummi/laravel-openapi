 ...
 * {@see \Radiergummi\OpenApi\Core\Extractors\StandardResponsesExtractor}: when a
 * `@throws` FQCN has no matching entry in the exception map or
 * `#[ExceptionResponse]` attribute, that extractor emits this rule ID directly
...
{
    /**
     * fixHint: emitted by StandardResponsesExtractor alongside every throws.unmapped finding.
     * The actual hint text is context-aware (app vs vendor exception) and built at emit time.
     */
